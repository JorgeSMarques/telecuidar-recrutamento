...
import { D as Circle, H as createContextScope, N as useControllableState, P as Presence, S as useSize, U as useComposedRefs, W as composeEventHandlers, i as useDirection, k as Check, n as Root, r as createRovingFocusGroupScope, t as Item, z as Primitive } from "./index-D569DpPl.js";
...
var RadioGroupItem = import_react.forwardRef(({ className, ...props }, ref) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item2, {
		...
		"data-prohibitions": "[editContent]",
		ref,
		className: cn("aspect-square h-5 w-5 rounded-full border-2 border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200", className),
		...props,
...
var Checkbox = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox$1, {
	...
	"data-prohibitions": "[editContent]",
	ref,
	className: cn("peer h-5 w-5 shrink-0 rounded-sm border-2 border-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground transition-all duration-200", className),
	...props,
...
//# sourceMappingURL=checkbox-BbKWtehT.js.map