...
import { A as createLucideIcon, B as createCollection, C as useId, F as Portal$1, H as createContextScope, I as useLayoutEffect2, J as require_react_dom, L as DismissableLayer, M as VISUALLY_HIDDEN_STYLES, N as useControllableState, R as useCallbackRef, U as useComposedRefs, V as createSlot, W as composeEventHandlers, _ as Anchor, b as Root2$1, c as ReactRemoveScroll, i as useDirection, k as Check, l as useFocusGuards, s as hideOthers, u as FocusScope, v as Arrow, x as createPopperScope, y as Content, z as Primitive } from "./index-D569DpPl.js";
import { t as usePrevious } from "./dist-Ci_v98gO.js";
var ChevronUp = createLucideIcon("chevron-up", [["path", {
	d: "m18 15-6-6-6 6",
	key: "153udz"
}]]);
//#endregion
//#region ../../cache/modules/telecuidar-ui-skeleton-83d50/node_modules/.pnpm/@radix-ui+number@1.1.1/node_modules/@radix-ui/number/dist/index.mjs
...
//#endregion
//#region ../../cache/modules/telecuidar-ui-skeleton-83d50/node_modules/.pnpm/@radix-ui+react-select@2.2.6_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_bb2c087fbe927e1f3c46e91de68a4ad7/node_modules/@radix-ui/react-select/dist/index.mjs
...
var SelectTrigger = import_react.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Trigger, {
	...
	ref,
	className: cn("flex w-full items-center justify-between rounded-[var(--radius)] border border-input bg-background text-foreground px-4 py-3 text-sm ring-offset-background data-[placeholder]:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:border-ring disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-muted/30 transition-all duration-200 ease-out aria-[invalid=true]:border-destructive aria-[invalid=true]:ring-destructive aria-[invalid=true]:focus:ring-destructive data-[warning=true]:border-ring data-[warning=true]:ring-ring data-[warning=true]:focus:ring-ring [&>span]:line-clamp-1", className),
	...props,
...
//# sourceMappingURL=select-DgDhD2ZK.js.map