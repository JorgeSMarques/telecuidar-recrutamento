...
import { A as createLucideIcon, C as useId, H as createContextScope, N as useControllableState, P as Presence, W as composeEventHandlers, i as useDirection, n as Root, r as createRovingFocusGroupScope, t as Item, z as Primitive } from "./index-CQ1crPcp.js";
...
var TabsList = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(List, {
	...
	ref,
	className: cn("inline-flex h-auto items-center justify-start border-b border-border w-full text-muted-foreground", className),
	...props
}));
...
var TabsTrigger = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trigger, {
	...
	"data-prohibitions": "[editContent]",
	ref,
	className: cn("inline-flex items-center justify-center whitespace-nowrap px-4 py-2 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:text-foreground data-[state=active]:opacity-100 opacity-70 border-b-2 border-transparent", className),
	...props
}));
...
//# sourceMappingURL=tabs-B8UraUii.js.map