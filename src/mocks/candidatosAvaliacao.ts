...
export const mockCandidatosAvaliacao: CandidatoAvaliacao[] = [
  {
    id: '1',
    nome: 'Dr. João Silva',
    ...
    formulario: {
      ...
      respostas: {
        'Descreva uma situação difícil':
          'Lidei com um paciente agressivo usando calma e escuta ativa, garantindo a segurança de todos na sala.',
      },
    },
    buscaWeb: {
      status: 'Concluída',
  ...
  },
  {
    ...
    formulario: {
      ...
      respostas: {
        'Descreva uma situação difícil':
          'Apoio contínuo a familiares em luto após perdas irreparáveis na UTI neonatal.',
      },
    },
    buscaWeb: {
      status: 'Concluída',
  ...
  },
  {
    ...
    formulario: {
      ...
      respostas: {
        'Descreva uma situação difícil':
          'Conflito com a equipe de enfermagem por não seguirem os protocolos de medicação exatamente como prescritos.',
      },
    },
    buscaWeb: {
      status: 'Concluída',
